...
const Report = ({ report }) => {
    ...
    return (
        <div className="min-h-screen bg-gray-50 py-10 px-4 md:px-8 w-full">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-8">
                    ...
                    <div className="space-y-6">
                        <motion.div 
                            ...
                            className="bg-white p-6 md:p-8 rounded-3xl shadow-sm text-center border border-gray-100"
                        >
                    ...
                    <motion.div 
                        ...
                        className="lg:col-span-2 bg-white p-6 md:p-8 rounded-3xl shadow-sm border border-gray-100 flex flex-col"
                    >
